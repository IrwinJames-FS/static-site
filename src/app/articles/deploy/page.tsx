...
const Deploy = () => (<Article>
  <Section>
	...
	<P>Nextjs to me is the wonderful evolution of react. with the ability to define fully functional server and client interactions within a workspace is great! Because NextJS allows us to build full functional server and client relationships I thought that deploying to github pages would be difficult however I was pleasantly surprised.</P>
  </Section>
...
export const metadata: Metadata = {
	title: "Deploy a Nextjs Site to github",
	description: "Tapping into CI/CD",
  };
